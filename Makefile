...
CLANG_CFLAGS=-std=c11 -Wall -Wextra -Wno-unused-parameter -O3 -ffast-math -march=native -fopenmp -D N_VALUE=$(N) -Rpass=loop-vectorize -Rpass-missed=loop-vectorize -fopenmp-simd
LDFLAGS=
