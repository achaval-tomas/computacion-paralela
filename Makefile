...
CLANG_CFLAGS=-std=c11 -Wall -Wextra -Wno-unused-parameter -O3 -ffast-math -ftree-vectorize -funroll-loops -Rpass=loop-vectorize -Rpass-missed=loop-vectorize -march=native
LDFLAGS=
